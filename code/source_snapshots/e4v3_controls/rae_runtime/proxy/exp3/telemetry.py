...
TELEMETRY_VERSION: Final = "exp3-runtime-telemetry-v3"
...
def _sum_budget_records(
    ...
    first_max_calls = _safe_nonnegative_int("max_calls", values[0].get("max_calls"))
    first_max_tokens = _safe_nonnegative_int("max_tokens", values[0].get("max_tokens"))
    for item in values:
        if (
            _safe_nonnegative_int("max_calls", item.get("max_calls")) != first_max_calls
    ...
    return {
        ...
        "max_calls": first_max_calls * planned_attempts,
