#!/usr/bin/env python3
"""Fail-closed builder for the prospective E3V15 T3 pair schedule.
...
def build_agreement(config: dict[str, Any], output: Path) -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        "schema_version": "exp3-e3v15-agreement-v1",
        "experiment_id": "E3V15",
        ...
        "registered_changes_from_e3v14": controls.REGISTERED_CHANGES_FROM_E3V14,
        "execution_policy": {
    ...
    try:
        ...
        _write_json(
            ...
            {
                "schema_version": "exp3-e3v15-agreement-sha256-v1",
...
def main() -> int:
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": "exp3-e3v15-builder-status-v1",
                    "status": "unready",
