#!/usr/bin/env python3
"""Build the separately bound E3V11 formal-launch package.
...
try:
    from . import controls, preflight_e3v11
except ImportError:  # pragma: no cover - direct script execution
    import controls  # type: ignore[no-redef]
    import preflight_e3v11  # type: ignore[no-redef]
...
LAUNCH_CONTROL_FILES = (
    "experiments/exp3/e3v11/build_e3v11_launch_package.py",
    "experiments/exp3/e3v11/run_e3v11_observation.py",
    "experiments/exp3/e3v11/run_e3v11_pair.py",
...
def build(
    *,
    ...
    for replicate in range(1, 6):
        result = preflight_e3v11.preflight(
            config,
            replicate=replicate,
    ...
    try:
        ...
        manifest: dict[str, Any] = {
            "schema_version": "exp3-e3v11-launch-package-v1",
        ...
        _write_json(
            ...
            {
                "schema_version": "exp3-e3v11-launch-package-sha256-v1",
