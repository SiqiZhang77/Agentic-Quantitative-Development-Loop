#!/usr/bin/env python3
"""Build the separately bound E3V13 formal-launch package.
...
try:
    from . import controls, preflight_e3v13
except ImportError:  # pragma: no cover - direct script execution
    import controls  # type: ignore[no-redef]
    import preflight_e3v13  # type: ignore[no-redef]
...
def build(
    *,
    ...
    for replicate in range(1, 6):
        result = preflight_e3v13.preflight(
            config,
            replicate=replicate,
    ...
    try:
        ...
        manifest: dict[str, Any] = {
            "schema_version": "exp3-e3v13-launch-package-v1",
        ...
        _write_json(
            ...
            {
                "schema_version": "exp3-e3v13-launch-package-sha256-v1",
