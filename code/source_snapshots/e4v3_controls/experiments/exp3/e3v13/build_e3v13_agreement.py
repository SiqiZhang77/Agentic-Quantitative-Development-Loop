#!/usr/bin/env python3
"""Fail-closed builder for the prospective E3V13 T3 pair schedule.
...
def build_agreement(config: dict[str, Any], output: Path) -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        "schema_version": "exp3-e3v13-agreement-v1",
        "experiment_id": "E3V13",
        ...
        "registered_changes_from_e3v12": controls.REGISTERED_CHANGES_FROM_E3V12,
        "execution_policy": {
    ...
    try:
        ...
        _write_json(
            ...
            {
                "schema_version": "exp3-e3v13-agreement-sha256-v1",
...
def main() -> int:
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": "exp3-e3v13-builder-status-v1",
                    "status": "unready",
