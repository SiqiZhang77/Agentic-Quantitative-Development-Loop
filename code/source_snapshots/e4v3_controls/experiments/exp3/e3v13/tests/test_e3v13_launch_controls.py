...
from experiments.exp3.e3v13 import build_e3v13_launch_package as launch
from experiments.exp3.e3v13 import controls
from experiments.exp3.e3v13 import run_e3v13_observation as observation
...
def _resolved_config() -> dict:
    ...
    config["source"]["source_ref"] = "exp/shared-t3-runtime-v4"
...
def _identity(arm: str = "M0") -> dict:
    ...
    value = {
        "run_id": f"E3V13-T3-R1-{arm}",
        "replicate": 1,
        "sequence_in_pair": 1 if arm == "M0" else 2,
        "arm": arm,
        "architecture_mode": architecture,
        "target_ref": f"quant/E3V13-T3-R1-{arm}",
        "paired_target_ref": f"quant/E3V13-T3-R1-{paired_arm}",
        "source": {
...
def test_launch_scripts_do_not_import_provider_clients() -> None:
    for name in (
        "build_e3v13_launch_package.py",
        "run_e3v13_observation.py",
        "run_e3v13_pair.py",
    ):
