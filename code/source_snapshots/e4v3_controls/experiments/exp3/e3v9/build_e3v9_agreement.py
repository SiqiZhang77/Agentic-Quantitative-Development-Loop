#!/usr/bin/env python3
"""Fail-closed builder for the prospective E3V9 T3 pair schedule.
...
def build_agreement(config: dict[str, Any], output: Path) -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        "schema_version": "exp3-e3v9-agreement-v1",
        "experiment_id": "E3V9",
    ...
    try:
        ...
        _write_json(
            ...
            {
                "schema_version": "exp3-e3v9-agreement-sha256-v1",
...
def main() -> int:
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": "exp3-e3v9-builder-status-v1",
                    "status": "unready",
