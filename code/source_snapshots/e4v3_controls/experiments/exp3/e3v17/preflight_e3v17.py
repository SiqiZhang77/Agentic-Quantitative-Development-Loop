#!/usr/bin/env python3
"""Zero-model preflight for one future E3V17 M0/M1 pair."""
...
def _agreement_issues(
    ...
    if schedule_record != expected_schedule:
        issues.append("frozen schedule does not match the resolved E3V17 configuration")
    ...
    if agreement.get("registered_changes_from_e3v16") != (
        controls.REGISTERED_CHANGES_FROM_E3V16
    ):
        issues.append("agreement E3V16-to-E3V17 change declaration is invalid")
...
def preflight(
    ...
    *,
    ...
    result: dict[str, Any] = {
        "schema_version": "exp3-e3v17-pair-preflight-v1",
        "experiment_id": "E3V17",
