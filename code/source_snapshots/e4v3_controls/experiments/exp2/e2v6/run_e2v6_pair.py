#!/usr/bin/env python3
"""Preflight all ten E2V6 observations or execute one C0/C1 pair."""
...
OUTPUT_ROOT = (
    ...
    / "02_EXPERIMENT_CONTROL"
    / "status-and-logs"
    / "exp2-terra-t3-rag-v6-observations"
)
AUTHORIZATION_ENV = "E2V6_PAIR_AUTHORIZATION"
...
BUILDER = _load_module("exp2_terra_t3_rag_v6_builder", HERE / "build_control_package.py")
PROJECTION = _load_module("exp2_e2v6_item_store_projection", HERE / "item_store_projection.py")
