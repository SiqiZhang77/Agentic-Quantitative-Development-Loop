#!/usr/bin/env python3
"""Resolve the E3V11 draft from reviewed public and hash-only inputs.
...
E3V11_ROOT = CONTROL_ROOT / "experiments" / "exp3" / "e3v11"
PROSPECTIVE_CONFIG = E3V11_ROOT / "config" / "e3v11.prospective.json"
CONTROL_FILES = (
    "experiments/exp3/e3v11/controls.py",
    "experiments/exp3/e3v11/build_e3v11_agreement.py",
    "experiments/exp3/e3v11/preflight_e3v11.py",
    "experiments/exp3/e3v11/item_store_projection.py",
    "experiments/exp3/e3v11/schemas/e3v11_config.schema.json",
    "experiments/prospective_freezes/e3v11/collect_public_bindings.py",
    "experiments/prospective_freezes/e3v11/collect_private_evaluator_bindings.py",
    "experiments/prospective_freezes/e3v11/build_freeze_config.py",
    "experiments/prospective_freezes/e3v11/build_scorer_result_v2.py",
    "experiments/prospective_freezes/e3v11/model_visible_trace_schema_v1.json",
)


class FreezeConfigError(RuntimeError):
    """The supplied evidence cannot safely resolve the E3V11 draft."""
...
def _controls_module():
    path = E3V11_ROOT / "controls.py"
    spec = importlib.util.spec_from_file_location("e3v11_freeze_controls", path)
    if spec is None or spec.loader is None:
        raise FreezeConfigError("cannot load E3V11 controls")
...
def _validate_public(value: dict[str, Any]) -> None:
    if value.get("schema_version") != "shared-t3-e3v11-public-binding-inventory-v1":
        raise FreezeConfigError("public binding inventory schema is not E3V11 v1")
...
def _validate_private(value: dict[str, Any]) -> None:
    ...
    if value["schema_version"] != "exp3-e3v11-private-evaluator-hashes-v1":
        raise FreezeConfigError("private evaluator manifest schema is not E3V11 v1")
    ...
    *,
    ...
    config["evaluation"] = {
        ...
        "item_store_projection_sha256": _sha256_file(
            E3V11_ROOT / "item_store_projection.py"
        ),
    }
    config["control"] = {
