#!/usr/bin/env python3
"""Resolve the E3V14 draft from reviewed public and hash-only inputs.
...
E3V14_ROOT = CONTROL_ROOT / "experiments" / "exp3" / "e3v14"
PROSPECTIVE_CONFIG = E3V14_ROOT / "config" / "e3v14.prospective.json"
CONTROL_FILES = (
    "experiments/exp3/e3v14/controls.py",
    "experiments/exp3/e3v14/build_e3v14_agreement.py",
    "experiments/exp3/e3v14/preflight_e3v14.py",
    "experiments/exp3/e3v14/item_store_projection.py",
    "experiments/exp3/e3v14/build_e3v14_launch_package.py",
    "experiments/exp3/e3v14/run_e3v14_observation.py",
    "experiments/exp3/e3v14/run_e3v14_pair.py",
    "experiments/exp3/e3v14/schemas/e3v14_config.schema.json",
    "experiments/prospective_freezes/e3v14/collect_public_bindings.py",
    "experiments/prospective_freezes/e3v14/collect_private_evaluator_bindings.py",
    "experiments/prospective_freezes/e3v14/build_freeze_config.py",
    "experiments/prospective_freezes/e3v14/build_scorer_result_v2.py",
    "experiments/prospective_freezes/e3v14/model_visible_trace_schema_v1.json",
)


class FreezeConfigError(RuntimeError):
    """The supplied evidence cannot safely resolve the E3V14 draft."""
...
def _controls_module():
    path = E3V14_ROOT / "controls.py"
    spec = importlib.util.spec_from_file_location("e3v14_freeze_controls", path)
    if spec is None or spec.loader is None:
        raise FreezeConfigError("cannot load E3V14 controls")
...
def _validate_public(value: dict[str, Any]) -> None:
    if value.get("schema_version") != "shared-t3-e3v14-public-binding-inventory-v1":
        raise FreezeConfigError("public binding inventory schema is not E3V14 v1")
...
def _validate_private(value: dict[str, Any]) -> None:
    ...
    if value["schema_version"] != "exp3-e3v14-private-evaluator-hashes-v1":
        raise FreezeConfigError("private evaluator manifest schema is not E3V14 v1")
    ...
    *,
    ...
    config["evaluation"] = {
        ...
        "item_store_projection_sha256": _sha256_file(
            E3V14_ROOT / "item_store_projection.py"
        ),
    }
    config["control"] = {
