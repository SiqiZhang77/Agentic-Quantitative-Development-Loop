#!/usr/bin/env python3
"""Resolve the E3V13 draft from reviewed public and hash-only inputs.
...
E3V13_ROOT = CONTROL_ROOT / "experiments" / "exp3" / "e3v13"
PROSPECTIVE_CONFIG = E3V13_ROOT / "config" / "e3v13.prospective.json"
CONTROL_FILES = (
    "experiments/exp3/e3v13/controls.py",
    "experiments/exp3/e3v13/build_e3v13_agreement.py",
    "experiments/exp3/e3v13/preflight_e3v13.py",
    "experiments/exp3/e3v13/item_store_projection.py",
    "experiments/exp3/e3v13/build_e3v13_launch_package.py",
    "experiments/exp3/e3v13/run_e3v13_observation.py",
    "experiments/exp3/e3v13/run_e3v13_pair.py",
    "experiments/exp3/e3v13/schemas/e3v13_config.schema.json",
    "experiments/prospective_freezes/e3v13/collect_public_bindings.py",
    "experiments/prospective_freezes/e3v13/collect_private_evaluator_bindings.py",
    "experiments/prospective_freezes/e3v13/build_freeze_config.py",
    "experiments/prospective_freezes/e3v13/build_scorer_result_v2.py",
    "experiments/prospective_freezes/e3v13/model_visible_trace_schema_v1.json",
)


class FreezeConfigError(RuntimeError):
    """The supplied evidence cannot safely resolve the E3V13 draft."""
...
def _controls_module():
    path = E3V13_ROOT / "controls.py"
    spec = importlib.util.spec_from_file_location("e3v13_freeze_controls", path)
    if spec is None or spec.loader is None:
        raise FreezeConfigError("cannot load E3V13 controls")
...
def _validate_public(value: dict[str, Any]) -> None:
    if value.get("schema_version") != "shared-t3-e3v13-public-binding-inventory-v1":
        raise FreezeConfigError("public binding inventory schema is not E3V13 v1")
...
def _validate_private(value: dict[str, Any]) -> None:
    ...
    if value["schema_version"] != "exp3-e3v13-private-evaluator-hashes-v1":
        raise FreezeConfigError("private evaluator manifest schema is not E3V13 v1")
    ...
    *,
    ...
    config["evaluation"] = {
        ...
        "item_store_projection_sha256": _sha256_file(
            E3V13_ROOT / "item_store_projection.py"
        ),
    }
    config["control"] = {
