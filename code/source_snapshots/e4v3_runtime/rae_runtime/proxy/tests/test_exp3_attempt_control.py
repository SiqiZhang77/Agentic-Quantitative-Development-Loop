...
def test_two_attempt_contract_accepts_frozen_500k_attempt_profile():
    payload = _payload()
    payload["iteration_controls"]["max_token_budget_per_run"] = 1_000_000

    validate_two_attempt_controls(payload)

    assert token_budget_per_attempt(payload) == 500_000
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("max_agent_turns", 21),
        ("max_token_budget_per_run", 800_000),
    ],
)
