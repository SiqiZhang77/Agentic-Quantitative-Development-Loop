...
def run_manager_star(
    ...
    *,
    ...
    # The Architect has now completed the only upstream planning stage.  Any
    # unused Architect calls become Developer capacity, while Manager's final
    # review reservation remains untouched.  This keeps the M1 total at the
    # same 20-call cap as M0 without discarding already allocated capacity.
    active_ledger.release_unused_architect_calls_to_developer()
