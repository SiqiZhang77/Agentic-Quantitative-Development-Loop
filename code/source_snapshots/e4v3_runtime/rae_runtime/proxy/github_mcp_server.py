...
def create_mcp_server():
    ...
    if os.getenv("RAE_ENABLE_QUANT_CALCULATOR") == "true":
        ...
        def quant_calculate(request: QuantCalculateRequest) -> dict[str, Any]:
            ...
            the tool. A failed or partial call does not end the current agent
            attempt: inspect the safe failed-operation and failed-argument fields,
            correct the request, and call this tool again within the fixed call cap.
            """
