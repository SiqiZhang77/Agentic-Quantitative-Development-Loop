#!/usr/bin/env python3
"""Build E4V1 only after every prospective binding is explicitly resolved.

The checked-in configuration is intentionally unready. Therefore the normal
current behavior is a structured refusal and no output directory. This module
never calls a model, retriever, evaluator, container, GitHub, Jira or Airflow.
"""
...
def build_agreement(config: dict[str, Any], output: Path) -> dict[str, Any]:
    ...
    manifest: dict[str, Any] = {
        "schema_version": "exp4-e4v1-agreement-v1",
        "experiment_id": "E4V1",
        ...
        "observations_per_authorization": 4,
    ...
    try:
        ...
        _write_json(
            ...
            {
                "schema_version": "exp4-e4v1-agreement-sha256-v1",
...
def main() -> int:
    ...
    try:
        ...
        print(
            json.dumps(
                {
                    "schema_version": "exp4-e4v1-builder-status-v1",
                    "status": "unready",
