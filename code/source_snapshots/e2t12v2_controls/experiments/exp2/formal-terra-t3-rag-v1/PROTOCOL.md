# Experiment 2 Terra T3 RAG/no-RAG formal control

This package controls a new six-observation T3 study. It does not change or
extend the existing T1/T2 agreement.
