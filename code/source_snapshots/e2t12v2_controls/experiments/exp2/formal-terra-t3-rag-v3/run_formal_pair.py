#!/usr/bin/env python3
"""Preflight all six E2 T3 v3 observations or execute one C0/C1 pair."""
...
OUTPUT_ROOT = (
    ...
    / "02_EXPERIMENT_CONTROL"
    / "status-and-logs"
    / "exp2-terra-t3-rag-v3-observations"
)
AUTHORIZATION_ENV = "E2_T3_RAG_V3_PAIR_AUTHORIZATION"
...
BUILDER = _load_module("exp2_terra_t3_rag_v3_builder", HERE / "build_control_package.py")
