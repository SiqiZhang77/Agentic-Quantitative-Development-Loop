...
SCHEMA_VERSION = "exp3-terra-agreement-v1.4"
EXPERIMENT_ID = "E3-manager-star-v1"
SOURCE_REF = "exp3/terra-source-v4"
SOURCE_COMMIT = "90a204f8d44463cfcf27726648b7d0a7e35d7c57"
IMAGE_DIGEST = "sha256:61532d905df11348dad47d5f3cdc950b5183b5c66e319b298711acd183f5a407"
...
def build(output: Path, *, replace: bool = False) -> dict[str, Any]:
    ...
    try:
        ...
        _write_json(
            ...
            {
                "schema_version": "exp3-terra-agreement-digest-v1.4",
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=HERE / "agreement-terra-v1.4",
    )
